...
__defaults__ = {
 ...
 ui.add_element(
    ...
    LabeledValue(
        ...
        value=0,
        position=(
            int(self.options.get("lvl_x_coord", self.__defaults__["lvl_x_coord"])),
            int(self.options.get("lvl_y_coord", self.__defaults__["lvl_y_coord"])),
        ),
        label_font=fonts.Bold,
        text_font=fonts.Medium,
    ),
...
def on_ui_update(self, ui):
    ...
    symbols_count = int(self.options.get("bar_symbols_count", self.__defaults__["bar_symbols_count"]))
